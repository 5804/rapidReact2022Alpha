...
public class TestSHtoTCommandGroup extends SequentialCommandGroup {
  /** Creates a new TestSHtoTCommandGroup. */
  public TestSHtoTCommandGroup(DrivetrainSubsystem dts, IntakeSubsystem is) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());


    PathPlannerTrajectory trajectory1 = PathPlanner.loadPath("SHtoT2", 3, 1);
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
