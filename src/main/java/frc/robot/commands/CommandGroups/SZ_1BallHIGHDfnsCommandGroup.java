...
public class SZ_1BallHIGHDfnsCommandGroup extends SequentialCommandGroup {
  /** Creates a new S1_2BallCommandGroup. */
  public SZ_1BallHIGHDfnsCommandGroup(DrivetrainSubsystem dts, ShooterSubsystem shooter, IntakeSubsystem is, LimelightSubsystem ls) { //TODO IMPLIMENT SHOOTER
    PathPlannerTrajectory trajectory1 = PathPlanner.loadPath("Def1B", 3, 1);
