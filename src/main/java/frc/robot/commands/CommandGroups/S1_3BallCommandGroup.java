...
public class S1_3BallCommandGroup extends SequentialCommandGroup {

  /** Creates a new S1_3BallCommandGroup. */
  public S1_3BallCommandGroup(DrivetrainSubsystem dts, ShooterSubsystem shooter, IntakeSubsystem is) {
    
  PathPlannerTrajectory trajectory1 = PathPlanner.loadPath("Start1ToA", 3, 1);
  PathPlannerTrajectory trajectory2 = PathPlanner.loadPath("1_AtoB", 3, 1);
