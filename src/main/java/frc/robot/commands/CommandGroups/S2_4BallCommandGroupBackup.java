...
public class S2_4BallCommandGroupBackup extends SequentialCommandGroup {
 
  /** Creates a new S2_2BallCommandGroup. */
  public S2_4BallCommandGroupBackup(DrivetrainSubsystem dts, ShooterSubsystem shooter, IntakeSubsystem is, LimelightSubsystem ls) {
    PathPlannerTrajectory trajectory1 = PathPlanner.loadPath("4BallBackupPart1", 3, 3);
    PathPlannerTrajectory trajectory2 = PathPlanner.loadPath("4BallBackupPart2", 5, 5);
    PathPlannerTrajectory trajectory3 = PathPlanner.loadPath("4BallBackupPart3", 5, 5);
