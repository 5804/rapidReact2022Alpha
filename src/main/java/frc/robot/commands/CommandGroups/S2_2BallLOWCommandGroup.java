...
public class S2_2BallLOWCommandGroup extends SequentialCommandGroup {
  /** Creates a new S1_2BallCommandGroup. */
  public S2_2BallLOWCommandGroup(DrivetrainSubsystem dts, ShooterSubsystem shooter, IntakeSubsystem is, LimelightSubsystem ls) { //TODO IMPLIMENT SHOOTER
    PathPlannerTrajectory trajectory1 = PathPlanner.loadPath("2_StartToB", 3, 1);
    PathPlannerTrajectory trajectory2 = PathPlanner.loadPath("BtoLow", 3, 1);
