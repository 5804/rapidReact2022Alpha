...
public class S3_2BallLOWCommandGroup extends SequentialCommandGroup {
  /** Creates a new S1_2BallCommandGroup. */
  public S3_2BallLOWCommandGroup(DrivetrainSubsystem dts, ShooterSubsystem shooter, IntakeSubsystem is, LimelightSubsystem ls) { //TODO IMPLIMENT SHOOTER
    PathPlannerTrajectory trajectory1 = PathPlanner.loadPath("3_StartToC", 3, 1);
    PathPlannerTrajectory trajectory2 = PathPlanner.loadPath("CtoLow", 3, 1);
